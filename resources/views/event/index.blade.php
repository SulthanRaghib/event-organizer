                                            ...
                                            <div class="text-center text-md-start card-hover">
                                                <div class="card-body">
                                                    ...
                                                    <p class="mt-4 mb-md-0 mb-lg-3 fw-light lh-base text-start">Maiores
                                                        voluptas laboriosam non dolorum perferendis fuga repellat aut.
                                                        Blanditiis quos in minus. Voluptatum quia quia voluptas voluptatem
                                                        vero ex possimus. </p>
                                                    <div class="d-flex flex-between-center">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <svg class="bi bi-alarm me-2" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <div class="text-center text-md-start card-hover">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center"><span
                                                        ...
                                                        <h6 class="fw-light fs-1 fs-lg-2 text-start ms-3">University
                                                            Admissions</h6>
                                                    </div>
                                                    <p class="mt-4 mb-md-0 mb-lg-3 fw-light lh-base text-start">Maiores
                                                        voluptas laboriosam non dolorum perferendis fuga repellat aut.
                                            ...
                                            <div class="text-center text-md-start card-hover">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center"><span
                                                        ...
                                                        <h6 class="fw-light fs-1 fs-lg-2 text-start ms-3">Visa COnsultancy
                                                        </h6>
                                                    </div>
                                                    <p class="mt-4 mb-md-0 mb-lg-3 fw-light lh-base text-start">Maiores
                                                        voluptas laboriosam non dolorum perferendis fuga repellat aut.
                                            ...
                                            <div class="text-center text-md-start card-hover">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center"><span
                                                        ...
                                                        <h6 class="fw-light fs-1 fs-lg-2 text-start ms-3">Accommodation
                                                        </h6>
                                                    </div>
                                                    <p class="mt-4 mb-md-0 mb-lg-3 fw-light lh-base text-start">Maiores
                                                        voluptas laboriosam non dolorum perferendis fuga repellat aut.
                                            ...
                                            <div class="text-center text-md-start card-hover">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center"><span
                                                            class="badge bg-soft-primary text-primary fs--1 fw-light p-3 rounded-1"><span
                                                                class="fw-medium fs-1 mb-2">23</span><br>Dec</span>
                                                        <h6 class="fw-light fs-1 fs-lg-2 text-start ms-3">Pre-Departure
                                                            Briefing</h6>
                                                    </div>
                                                    <p class="mt-4 mb-md-0 mb-lg-3 fw-light lh-base text-start">Maiores
                                                        voluptas laboriosam non dolorum perferendis fuga repellat aut.
