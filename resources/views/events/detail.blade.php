        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <a href="{{ route('events') }}" class="btn btn-outline-primary mb-3"><i class="fas fa-arrow-left"></i>
                        Kembali</a>
                </div>
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <a href="{{ route('events.register', $data->id_event) }}"
                            class="btn btn-success float-end">Register</a>
                    </div>
                </div>
