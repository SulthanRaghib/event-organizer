    ...
    <main class="main" id="top">
                ...
                <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto pt-2 pt-lg-0 font-base">
                        <li class="nav-item px-2">
                            <a class="nav-link {{ url()->current() == route('home') ? 'active fw-medium ' : '' }}"
                        ...
                        <li class="nav-item px-2">
                            <a class="nav-link {{ url()->current() == route('our-service') ? 'active fw-medium ' : '' }}"
                                href={{ url('our-service') }}>Our Services </a>
                        </li>
                    </ul>
                    {{-- <form class="ps-lg-5">
                    ...
                    @if (Auth::guest())
                        <a class="btn btn-outline-primary order-0" href="{{ url('/login') }}">Login</a>
                    @else
                        {{-- buatkan dropdown --}}
                        <div class="dropdown">
                            <button class="btn btn-outline-primary order-0 dropdown-toggle" type="button"
        ...
        <section class="py-0" id="home">
            <div class="bg-holder d-none d-md-block">
                <img src="{{ url('/frontend/assets/img/gallery/hero.png') }}" alt="..." class="bg-img"
                ...
                <div class="row justify-content-between pb-2 pt-8">
                    <div class="col-12 col-lg-auto mb-5 mb-lg-0"><a
                            class="d-flex align-items-center fw-semi-bold fs-3" href="#"> <img class="me-3"
                                src="{{ url('frontend/assets/img/gallery/footer-logo.png') }}" alt="..." /></a>
                    ...
                    <div class="col-auto mb-4 d-flex align-items-end">
                        <ul class="list-unstyled list-inline mb-0">
                            <li class="list-inline-item me-3"><a class="text-decoration-none" href="#!">
                                    <a><svg class="bi bi-facebook" xmlns="http://www.w3.org/2000/svg" width="20"
